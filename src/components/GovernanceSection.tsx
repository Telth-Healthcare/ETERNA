...
const contacts = [
  {
    ...
    title: "Book a Baseline Assessment",
    desc: "Tell us your goal and preferred location. We will respond with a diagnostic pathway, appointment options, and a proposed phase plan timeline.",
    cta: "Book Assessment",
  },
  {
    label: "For Organisations",
    title: "Buy a State-of-Art Longevity Hub",
    desc: "Deploy the Eterna Longevity Hub within your facility. Powered by TELTH OPERATING SYSTEMS with full clinical and technical support.",
    cta: "Enquire About the Hub",
  },
  {
    label: "For Partners",
    title: "Buy a Franchise",
    desc: "Bring Eterna to your market. Join a network of precision longevity centres operating under Harley Street clinical governance standards.",
...
export function GovernanceSection() {
  ...
  return (
    <section
      id="governance"
      className="relative bg-[#0a0a0a] px-4 md:px-8 lg:px-16 py-16 md:py-28 overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <div
          className={`transform transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <h2
            className="text-[#f0ead8] leading-[1.12] mb-3"
            style={{
          ...
          <p
            className="text-[#f0ead8]/40 text-sm leading-relaxed mb-12 max-w-2xl transform transition-all duration-1000 delay-200"
            style={{
              transform: visible ? "translateY(0)" : "translateY(20px)",
              opacity: visible ? 1 : 0,
            }}
          >
            Eterna maintains clinician oversight, informed consent, and
            phase-gated safety monitoring to minimise risk and ensure
            interventions remain clinically appropriate at every stage.
          </p>
        </div>
          ...
          {[
            ...
            >
              <div className="flex items-center gap-3 mb-5 group">
                <h3
                  className="text-[#f0ead8] text-xl relative"
                  style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: "1.2rem",
                    fontWeight: 400,
              ...
              <ul className="flex flex-col gap-3">
                {items.map((item, i) => (
                  ...
                  >
                    <span
                      className={`absolute left-0 text-[#c9a84c] text-[8px] top-1 transform transition-all duration-300 
                      ${hoveredIndex === i ? "scale-150 rotate-90" : ""}`}
                    >
                      ◆
                    </span>
                    <span
                      className={`transition-all duration-300 ${hoveredIndex === i ? "text-[#f0ead8]/80 pl-1" : ""}`}
                    >
                      {item}
                    </span>
                  </li>
...
export function PromiseSection() {
  ...
  return (
    <section
      id="promise"
      className="relative bg-[#0e0e14] px-4 md:px-8 lg:px-16 py-20 md:py-32 text-center overflow-hidden"
    >
      {/* Animated background */}
      <div className="absolute inset-0 pointer-events-none">
        <div
      ...
      <div ref={ref} className="relative z-10 max-w-3xl mx-auto">
        ...
        <div
          className={`flex items-center justify-center gap-3 mb-5 transform transition-all duration-1000 
          ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div
            className="w-6 h-px bg-[#c9a84c] transform origin-left transition-transform duration-1000 
          ...
          <div
            className="w-6 h-px bg-[#c9a84c] transform origin-right transition-transform duration-1000 
            ${visible ? 'scale-x-100' : 'scale-x-0'}"
          />
        </div>
        ...
        <h2
          className={`text-[#f0ead8] leading-[1.12] mb-8 transition-all duration-1000 ${
        ...
        <div
          className={`flex items-center justify-center gap-0 flex-wrap mb-8 transition-all duration-1000 delay-200 ${
        ...
        <p
          className={`text-[#f0ead8]/40 text-sm leading-relaxed mb-4 transition-all duration-1000 delay-300 ${
            visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
          Eterna transforms biomarker science into a clinically guided longevity
          journey — from early risk detection to personalised response, with
          safety at the centre of every step.
        </p>

        <p
          className={`text-[#f0ead8]/40 text-sm leading-relaxed mb-6 transition-all duration-1000 ${
            visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
          style={{ transitionDelay: "400ms" }}
        >
          Eterna is built for individuals and families who want more than
          routine healthcare. It is for those seeking a proactive, preventive,
          and precision-guided longevity journey supported by advanced
          diagnostics, integrative science, and structured care planning.
        </p>
        ...
        <div
          className={`flex gap-3 sm:gap-4 justify-center flex-wrap transition-all duration-1000 ${
            visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        ...
        >
          <button
            ...
            className="group relative bg-[#c9a84c] text-[#0a0a0a] px-6 sm:px-8 py-3.5 text-[10px] tracking-[0.22em] uppercase font-semibold overflow-hidden"
          >
          ...
          <button
            onClick={() => navigate("/contact")}
            className="group relative border border-[#c9a84c]/30 text-[#f0ead8] px-6 sm:px-8 py-3.5 text-[10px] tracking-[0.22em] uppercase overflow-hidden"
          >
...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative bg-gradient-to-b from-[#0e0e14] to-[#0a0a0a] border-t border-[#c9a84c]/15 px-4 md:px-8 lg:px-16 py-14 md:py-20 overflow-hidden"
    >
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {contacts.map((c, i) => (
            ...
            >
              {/* Card glow effect */}
              <div
                className={`absolute inset-0 bg-[#c9a84c]/5 blur-2xl transition-opacity duration-500 
                ${hoveredCard === i ? "opacity-100" : "opacity-0"}`}
              />

              {/* Card content */}
              <div
                className="relative bg-gradient-to-b from-[#c9a84c]/05 to-transparent p-6 text-center 
              ...
              >
                ...
                <div className="relative inline-block mb-2">
                  <div className="text-[#c9a84c] text-[9px] tracking-[0.3em] uppercase">
                    {c.label}
                  </div>
                  <span
                    className="absolute -bottom-1 left-1/2 w-0 h-px bg-[#c9a84c] group-hover:w-1/2 
                ...
                {/* Description */}
                <p
                  className="text-[#f0ead8]/40 text-[11px] leading-relaxed mb-5 transform transition-all duration-500
                ...
                <button
                  className="group/btn relative inline-flex items-center gap-2 border border-[#c9a84c]/25 
...
export function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-[#0a0a0a] to-[#0e0e14] border-t border-[#c9a84c]/10 px-4 md:px-8 lg:px-16 py-8 overflow-hidden">
      {/* Animated line */}
      <div
        className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#c9a84c]/50 to-transparent 
                    animate-pulse"
      />
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
        ...
        <div className="relative group">
          <div
            className="text-[#f0ead8]/18 text-[10px] leading-relaxed max-w-sm md:text-right
                        transition-all duration-300 group-hover:text-[#f0ead8]/30"
          >
            This website is informational and does not constitute medical
            advice. Services are delivered through licensed practitioners.
