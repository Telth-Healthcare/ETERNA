...
export function PartnersSection() {
  ...
  const partners = [
    {
      ...
      location: "London",
      image:
        "https://harleystreetlongevityclub.com/wp-content/uploads/2025/01/image-2.png",
    ...
    },
    {
      ...
      image:
        "https://wimpoleclinic.com/wp-content/uploads/WIMPOLE_CLINIC_FULL-COLOUR.png.webp", // Replace with actual SVG path
      ...
      fallbackContent: (
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#c9a84c]/10 to-transparent">
          <div className="text-center">
            ...
            <div className="text-[#f0ead8] text-xl font-light tracking-wider">
              PARTNER
            </div>
  ...
  return (
    <section
      id="partners"
      className="relative bg-gradient-to-b from-[#0e0e14] to-[#0a0a0a] px-4 md:px-8 lg:px-16 py-20 md:py-28 overflow-hidden"
    >
      {/* Animated background */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <h2
            className="text-[#f0ead8] leading-[1.12] mb-4"
            style={{
          ...
          <p className="text-[#f0ead8]/40 text-sm max-w-2xl mx-auto leading-relaxed">
            Eterna operates in partnership with world-class medical
            institutions, ensuring our longevity programmes are delivered with
          ...
          {partners.map((partner, index) => (
            ...
            >
              <div className="relative h-full">
                {/* Glow effect */}
                <div
                  className={`absolute inset-0 bg-[#c9a84c]/10 blur-3xl transition-opacity duration-700 
                  ${hoveredPartner === partner.id ? "opacity-100" : "opacity-0"}`}
                />

                {/* Card */}
                <div
                  className="relative bg-gradient-to-br from-[#c9a84c]/05 to-[#c9a84c]/02 
                ...
                >
                  ...
                  <div className="absolute top-4 right-4">
                    <span
                      className="text-[8px] tracking-[0.2em] text-[#c9a84c]/40 
                  ...
                  {/* Image container */}
                  <div
                    className="mb-6 h-48 md:h-56 relative overflow-hidden bg-[#0a0a0a] 
                  ...
                  >
                    ...
                    {partner.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <div className="text-center">
                          <div className="text-[#c9a84c] text-sm mb-2 opacity-60">
                            STRATEGIC
                          </div>
                          <div className="text-[#f0ead8] text-2xl font-light tracking-wider">
                            PARTNER
                          </div>
                    ...
                    <div
                      className="absolute inset-0 bg-gradient-to-t from-[#c9a84c]/20 to-transparent 
                  ...
                  <div className="text-center">
                    ...
                    {/* Decorative line */}
                    <div
                      className="w-12 h-px bg-gradient-to-r from-transparent via-[#c9a84c]/50 to-transparent 
        ...
        >
          ...
          <button
            ...
            className="mt-4 group relative inline-flex items-center gap-2 
          ...
          >
            ...
            <span
              className="absolute inset-0 bg-[#c9a84c]/10 transform -translate-x-full 
